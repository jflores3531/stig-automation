...
PyYAML for anything run from there. That is harmless while inventory.yaml stays
JSON, since JSON parses under either. What it does break is a YAML-formatted inventory on a machine
